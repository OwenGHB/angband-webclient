var games = [ 
  { name: 'angband',
    ...
    args: [] },
  { name: 'angband_master',
    longname: 'Angband nightly build',
    desc: 'The master development branch of Angband.',
    restrict_paths: false,
    data_paths: [],
    args: [] },
  { name: 'competition',
    longname: 'Competition 209',
    desc: 'Cuddles is a fierce young balance drake with a lot to prove. He wants to be taken seriously. NOTE: Playing this mode will overwrite your poschengband savefile. To continue a competition run, choose poschengband 7 from the game menu.',
    restrict_paths: false,
    data_paths: [],
    args: [] },
  { name: 'faangband',
  ...
  { name: 'hengband',
    ...
    desc: 'Japanese Zangband variant, progenitor of PosChengband. Older version - get in touch if you can help me get the 2.2.0 source code.',
    restrict_paths: false,
    data_paths: [],
    args: [] },
  { name: 'kangband',
    ...
    args: [] },
  { name: 'kamband',
    longname: 'Kamband 1.8c',
    desc: 'A variant of Kangband with an expanded wilderness, and sci-fi post-apocalyptic elements. Features the munchkin race.',
    restrict_paths: false,
    data_paths: [],
    args: [] },
  { name: 'multiband',
