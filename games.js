var games = [ 
  { name: 'angband',
    ...
    args: [] },
  { name: 'competition',
    longname: 'Competition 211',
    desc: 'Wilfred is not particularly strong nor brave, but he has his wits about him and a kingdom to save.',
    restrict_paths: false,
    data_paths: [],
    args: [] },
  { name: 'composband',
    longname: 'Composband 7.0.2a',
