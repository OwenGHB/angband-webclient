var games = [
	{name:'angband',longname:'Angband 4.1.0',desc:"The latest release of the classic dungeon exploration game inspired by the work of JRR Tolkien. Descended from Moria."},        
	{name:'competition',longname:'Competition 208',desc:"Taregor is a Druadan ranger who has taken it upon himself to rid Beleriand of evil. The way is fraught with peril,         but he has many talents."},        
	{name:'faangband',longname:'FAangband 1.4.4',desc:"Redesigned gameplay mechanics,         full of new features and new content,         including wilderness levels. Faithful to Tolkien. Descended from Oangband"},        
	{name:'hellband',longname:'Hellband 0.8.7',desc:"Fantasy renaissance Italian setting,         informed by demonology and inspired by Dante. Descended from Zangband. Won't load keymaps (i.e. movement) from default pref folder,         you have to make your own."},        
	{name:'nppangband',longname:'NPPAngband 7.1.0',desc:"Attempts to preserve classic angband gameplay but with various improvements."},        
	{name:'nppmoria',longname:'NPPMoria 7.1.0',desc:"A recreation of Moria using the NPPAngband engine."},        
